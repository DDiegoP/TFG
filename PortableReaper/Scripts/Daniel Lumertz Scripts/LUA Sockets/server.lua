...
print("aasdadsads")
--assert(udp2:setsockname("192.168.1.56",3002)) -- Set IP and PORT
...
udp2:settimeout(0.0001)
udp:setoption('broadcast',true)
local a = udp:getoption('broadcast')
print(a)
udp:sendto("A","192.168.1.56",3000)
local b = udp2:receivefrom()
print(tostring(b))
...
-- Main function
local function Main()
  local method = 6 -- change the method to get the osc. 
  ...
  elseif method == 5 then -- Getting just the newest udp message and cleaning the buffer
    ...
    --elseif method == 6 then -- a ver si funciona
     -- local b = udp:receivefrom(4)
     -- print(b)
   -- end
  end
